...
function showResults(count) {
  ...
  if (currentIndex === count) {
    ...
    backButton.style.width = "150px"; // Set the blue color style
    backButton.style.borderRadius = "20px"; // Set the blue color style
    backButton.style.color = "white"; // Set the blue color style

    backButton.style.hight = "100px"; // Set the blue color style
    backButton.style.marginLeft = "480px"; // Set the blue color style
